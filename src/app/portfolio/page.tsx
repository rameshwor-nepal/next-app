"use client";
import SmallWOrkCard from "@/components/portfolio/SmallWorkCard";
...
const PortfolioPage = () => {
  ...
  return (
    ...
    //                 {item.title}
    //               </h1>
    //               <div className="relative w-80 h-56 md:w-96 md:h-64 lg:w-[500px] lg:h-[290px] xl:w-[600px] xl:h-[340px]">
    ...
    <>
      <main className=" my-16 flex flex-col gap-12 mx-16 items-center justify-center">
        <h2 className='font-bold text-5xl mt-10 text-center'>
          Practice Makes Man Perfect!
        </h2>
        <div className="grid grid-cols-12 gap-y-20 gap-x-10">
          <div className="col-span-1"></div>
          <div className="col-span-10">
            <WorkCard
              title="MyMeet Video Streaming Site"
